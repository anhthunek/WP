...
define('FASHION_ESTORE_LIVE_DEMO',__('https://www.themagnifico.net/demo/fashion-ecommerce-zone/','fashion-ecommerce-zone'));
}
if ( ! defined( 'FASHION_ESTORE_GET_PREMIUM_PRO' ) ) {
define('FASHION_ESTORE_GET_PREMIUM_PRO',__('https://www.themagnifico.net/themes/fashion-portfolio-wordpress-theme/','fashion-ecommerce-zone'));
}
if ( ! defined( 'FASHION_ESTORE_PRO_DOC' ) ) {
define('FASHION_ESTORE_PRO_DOC',__('https://www.themagnifico.net/eard/wathiqa/fashion-ecommerce-zone-pro-doc/','fashion-ecommerce-zone'));
}
