        ...
        <div class="row">
            <div class="col-lg-3 col-md-12 align-self-center">
                <div class="navbar-brand">
                    ...
                    <?php endif; ?>
                    <?php $fashion_ecommerce_zone_blog_info = get_bloginfo( 'name' ); ?>
                        <?php if ( ! empty( $fashion_ecommerce_zone_blog_info ) ) : ?>
                        ...
                        <?php endif; ?>
                        <?php
                            $fashion_ecommerce_zone_description = get_bloginfo( 'description', 'display' );
                            if ( $fashion_ecommerce_zone_description || is_customize_preview() ) :
                        ?>
                        <?php if( get_theme_mod('fashion_estore_theme_description',false) != ''){ ?>
                        <p class="site-description"><?php echo esc_html($fashion_ecommerce_zone_description); ?></p>
                      <?php } ?>
                    <?php endif; ?>
                </div>
            </div>
